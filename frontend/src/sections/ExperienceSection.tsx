    ...
    >
      <div className="max-w-5xl w-full space-y-12">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-green-500/50 via-green-500/30 to-transparent transform md:-translate-x-1/2"></div>
          ...
          <div className="space-y-12">
            {experience.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-8 md:left-1/2 w-4 h-4 bg-green-400 rounded-full border-4 border-black transform md:-translate-x-1/2 z-10"></div>
